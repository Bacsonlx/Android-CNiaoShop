package hznu.linxin.cniaoshop_03.widget;
 ...
 *
 * 要使用FragmentTabHost，首先需要布局中添加进来，这里我们并没有使用官方提供的v4支持包中的FragmentTabHost，
 * 而是使用了我们自定义的FragmentTabHost，主要是因为官方提供的FragmentTabHost并没有进行优化，
 * 每次都会重新初始化一次Fragment。自定义FragmentTabHost的代码会在附件给出。
 */
